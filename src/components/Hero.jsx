  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-16 lg:py-24">
      ...
      <div className="container mx-auto px-4 lg:px-6 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-14 lg:gap-48 max-w-6xl mx-auto">
          {/* Text Content */}
          <motion.div
          ...
          >
            ...
            <div className="flex gap-4">
              <motion.a
                href="/Resume.pdf" // Ensure this matches your actual file name
                target="_blank"
                rel="noopener noreferrer"
                download // Forces the file to download
              ...
              <div className="flex gap-3">
                <motion.a
                  href="https://github.com/sricharan0510" // Replace with your GitHub URL
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            <motion.div
              className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-xl overflow-hidden group cursor-pointer flex items-center justify-center"
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
            >
              {/* Animated gradient background */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl blur-3xl opacity-30"
                animate={{
                  scale: [1, 1.2, 1],
                  rotate: [0, 180, 360],
                }}
              ...
              {/* Profile image - now square with rounded corners */}
              <motion.img
              ...
              <div className="absolute inset-0 rounded-xl border-2 border-purple-500/50 scale-105 opacity-0 group-hover:opacity-100 transition-all duration-300" />
            </motion.div>
          </motion.div>

...
const Navbar = () => {
    ...
    return (
        <motion.div
            className={`fixed top-0 left-0 w-full z-[40] transition-all duration-300 ${scrolled ? 'bg-[#030014]/80 backdrop-blur-md' : 'bg-transparent'
                }`}
            initial={{ y: -100 }}
            animate={{ y: 0 }}
        ...
        >
            ...
            <div className='max-w-[1300px] mx-auto flex justify-between items-center px-4 md:px-12 h-20'>
                ...
                <ul className='hidden md:flex items-center gap-8'>
                    {["skills", "projects", "Education & Experience", "certifications", "contact"].map((section, index) => (
                        <motion.li
                            key={section}
